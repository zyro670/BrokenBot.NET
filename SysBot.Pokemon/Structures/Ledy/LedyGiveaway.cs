...
{
    public class LedyGiveaway<T> where T : PKM, new()
    {
        public readonly Dictionary<string, LedyRequest<T>> UserRequests = new();
        public readonly Dictionary<string, LedyRequest<T>> Giveaway;

        public readonly PokemonPool<T> GiveawayPool;
        private readonly List<LedyUser> Previous = new();

        public LedyGiveaway(PokemonPool<T> giveawaypool)
        {
            GiveawayPool = giveawaypool;
            Giveaway = GiveawayPool.Files;
        }
